 ...
 class PSaw extends CI_Controller
 {
     ...
     public function dataSiswa()
     {
         ...
         if ($this->form_validation->run() == false) {
             ...
             $this->session->set_flashdata(
                 'message',
                 '<div <div align="center" class="alert alert-success" role="alert">
     ...
     public function hasilSAW()
     {
         ...
         $data['namauser'] = 'Admin SPK';
         $data['user'] = $this->ps->getEmail();
         $data['nilaipeminatansiswa'] = $this->ps->getJoinNilaiPeminatanSiswa();
         $data['nilai_peminatan'] = $this->ps->getNilaiPeminatan();
     ...
     {
         $data['judul'] = 'Rekomendasi Peminatan Siswa';
         $data['namauser'] = 'Admin SPK';
     ...
     {
         $data['judul'] = 'Data Hasil Rekomendasi Peminatan Mahasiswa';
         $data['namauser'] = 'Admin SPK';

         $data['user'] = $this->ps->getEmail();
         $data['cetak_nilai'] = $this->ps->getCetak();

         if ($this->form_validation->run() == false) {
             $this->load->view('templates/header', $data);
             $this->load->view('templates/sidebar', $data);
             $this->load->view('templates/topbar', $data);
             $this->load->view('pSaw/cetak_nilai', $data);
             $this->load->view('templates/footer');
             $this->load->view('templates/footer');
         }
     }
