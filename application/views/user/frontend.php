...
<body>
        ...
        <div class="main_menu">
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container">
                    ...
                    <!-- <a class="navbar-brand logo_h" href="index.html"><img src="<?= base_url(
                        'assets/frontend/'
                    ) ?>img/logo.png" alt="" /></a> -->
                    ...
                    <div class="col-lg-12">
                        <div class="banner_content text-center">
                            <p class="text-uppercase">
                                Sistem Pendukung Keputusan Pemilihan Peminatan
                            </p>
                            ...
                            <div>
                                <a href="<?= base_url(
                                    'auth'
                                ) ?>" class="primary-btn2 mb-3 mb-sm-0">Hitung Nilai Mahasiswa</a>
                                <a href="<?= base_url(
                                    'LaporanPdf/index'
                                ) ?>" class="primary-btn ml-sm-3 ml-0">Download Hasil</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row justify-content-center d-flex align-items-center">
                <div class="col-lg-3 col-md-6 col-sm-12 single-trainer">
                    <div class="thumb d-flex justify-content-sm-center">
                        <img class="img-fluid" src="<?= base_url(
                            'assets/frontend/'
                        ) ?>img/trainer/t1.jpg" alt="" />
                    </div>
        ...
        <div class="container">
            ...
            <div class="row footer-bottom d-flex justify-content-between">
                <p class="col-lg-8 col-sm-12 footer-text m-0 text-white">
                    ...
                    </script> Website Sistem Pendukung Keputusan Pemilihan Peminatan </i></a>
                    <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                </p>
    ...
    <script src="<?= base_url(
        'assets/frontend/'
    ) ?>vendors/nice-select/js/jquery.nice-select.min.js"></script>
    <script src="<?= base_url(
        'assets/frontend/'
    ) ?>vendors/owl-carousel/owl.carousel.min.js"></script>
    <script src="<?= base_url(
        'assets/frontend/'
    ) ?>js/owl-carousel-thumb.min.js"></script>
    <script src="<?= base_url(
        'assets/frontend/'
    ...
    <script src="<?= base_url(
        'assets/frontend/'
    ) ?>https://maps.googleapis.com/maps/api/js?key=AIzaSyCjCGmQ0Uq4exrzdcL6rvxywDDOvfAu6eE"></script>
