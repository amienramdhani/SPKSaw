                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_title">
                            ...
                            <a href="" class="btn btn-round btn-primary mb-3" data-toggle="modal" data-target="#modalTambahSiswa"> Tambah Mahassiswa</a>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($datasiswa as $ds): ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $ds['alamat'] ?></td>
                                            <td>
                                                <a href="" class="label btn-round btn-success" data-toggle="modal" data-target="#modalEditSiswa<?= $ds[
                                                    'id_siswa'
                                                ] ?>">edit</a>
                                                <a href="<?= base_url(
                                                    'pSaw/hapusSiswa/'
